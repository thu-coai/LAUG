...
from LAUG.nlu.milu_new import dataset_reader_frames, model_frames

from spacy.symbols import ORTH, LEMMA

DEFAULT_CUDA_DEVICE = -1
DEFAULT_DIRECTORY = "models"
DEFAULT_ARCHIVE_FILE = os.path.join(DEFAULT_DIRECTORY, "milu_multiwoz_new_context.tar.gz")
...
class MILU(NLU):
    ...
    def __init__(self,
                ...
                model_file="https://convlab.blob.core.windows.net/convlab-2/milu_multiwoz_new_context.tar.gz",
                context_size=3):
    ...
    def predict(self, utterance, context=list()):
        ...
        #instance = self.iterator.transfer_instance_list([instance])[0]
...
if __name__ == "__main__":
    ...
    #nlu = MILU(model_file='../0915test/model.tar.gz')
    nlu = MILU(model_file="../0110_frames_test/model.tar.gz")
    test_contexts = [
        "SENT_END",
        "SENT_END",
        "SENT_END",
