...
class Dataloader:
    def __init__(self, intent_vocab, tag_vocab, req_vocab, req_slot_vocab, slot_intent_vocab, pretrained_weights):
        """
    ...
    def pad_batch(self, batch_data): # TODO： add req tensor and req_mask tensor
