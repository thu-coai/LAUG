...
from LAUG.nlu.jointBERT_new.frames.postprocess import recover_intent
from LAUG.nlu.jointBERT_new.frames.preprocess import preprocess
...
if __name__ == '__main__':
    ...
    nlu = BERTNLU(config_file ='frames_usr_context.json',model_file='output/usr_context_fix_req/bert_frames_usr_context.zip')
